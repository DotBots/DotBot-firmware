...
int main(void) {
    ...
    NRF_SPIM0->RXD.PTR    = (uint32_t)&readerBuffer;  // Set the input buffer pointer.
    ...
    while (1) {
        ...
        NRF_SPIM0->TXD.PTR = (uint32_t)&led_cyan_buffer;
        // Execute a transfer
        ...
        NRF_SPIM0->TXD.PTR     = (uint32_t)&led_blue_buffer;
        NRF_SPIM0->TASKS_START = SPIM_TASKS_START_TASKS_START_Trigger << SPIM_TASKS_START_TASKS_START_Pos;
        WAIT_A_BIT(2000);

        // Set color of the LED to Magenta
        NRF_SPIM0->TXD.PTR     = (uint32_t)&led_magenta_buffer;
        NRF_SPIM0->TASKS_START = SPIM_TASKS_START_TASKS_START_Trigger << SPIM_TASKS_START_TASKS_START_Pos;
        WAIT_A_BIT(2000);

        // Set color of the LED to Red
        NRF_SPIM0->TXD.PTR     = (uint32_t)&led_red_buffer;
        NRF_SPIM0->TASKS_START = SPIM_TASKS_START_TASKS_START_Trigger << SPIM_TASKS_START_TASKS_START_Pos;
        WAIT_A_BIT(2000);

        // Set color of the LED to Yellow
        NRF_SPIM0->TXD.PTR     = (uint32_t)&led_yellow_buffer;
        NRF_SPIM0->TASKS_START = SPIM_TASKS_START_TASKS_START_Trigger << SPIM_TASKS_START_TASKS_START_Pos;
        WAIT_A_BIT(2000);

        // Set color of the LED to Green
        NRF_SPIM0->TXD.PTR     = (uint32_t)&led_green_buffer;
        NRF_SPIM0->TASKS_START = SPIM_TASKS_START_TASKS_START_Trigger << SPIM_TASKS_START_TASKS_START_Pos;
        WAIT_A_BIT(2000);

        // Set color of the LED to White
        NRF_SPIM0->TXD.PTR     = (uint32_t)&led_white_buffer;
        NRF_SPIM0->TASKS_START = SPIM_TASKS_START_TASKS_START_Trigger << SPIM_TASKS_START_TASKS_START_Pos;
        WAIT_A_BIT(2000);

        // Set color of the LED to Black
        NRF_SPIM0->TXD.PTR     = (uint32_t)&led_black_buffer;
        NRF_SPIM0->TASKS_START = SPIM_TASKS_START_TASKS_START_Trigger << SPIM_TASKS_START_TASKS_START_Pos;
        WAIT_A_BIT(2000);
    }
