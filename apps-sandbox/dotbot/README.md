...
taken from the previous sandbox app and `apps/dotbot` on purpose, and the reasoning
...
```
SEGGER_DIR="<install root>" BUILD_TARGET=sandbox-dotbot-v3 BUILD_CONFIG=Debug make dotbot
```
