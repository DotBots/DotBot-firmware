...
// time in µs1
#define t_start_ble  85
#define t_start_ieee 90

#define payload_size 80  // 16 for ble and 80 for 802.15.4
...
static void _gpio_callback(void *ctx) {
    ...
    db_timer_hf_set_oneshot_us(1, 8000, _disable_radio);
}
...
int main(void) {
    ...
    db_timer_init();
    db_timer_set_periodic_ms(0, 2000, _led3_blink);
    db_timer_hf_init();
